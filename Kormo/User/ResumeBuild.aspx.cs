    ...
    public partial class ResumeBuild : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (Request.QueryString["id"] != null)
                {
                    string concateQuery = string.Empty;
                    ...
                    if(fuResume.HasFile)
                    {
                        ...
                        {
                            concateQuery = "Resume=@resume,";
                            isValid = true;
                        }
                        else
                        {
                            concateQuery = string.Empty;
                        }
                    }
                    else
                    {
                    ...
                    query = @"Update [User] set Username=@Username,Name=@Name,Email=@Email,Mobile=@Mobile,
                        ...
                        PostGraduationGrade=@PostGraduationGrade,WorksOn=@WorksOn,Experience=@Experience,
                        " + concateQuery + "Address=@Address,Country=@Country where UserId=@UserId";
                    cmd = new SqlCommand(query, con);
                    ...
                    if(isValid)
                    {
                        ...
                        {
                            lblMsg.Visible = true;
                            lblMsg.Text = "Can not update the records, try again later!";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
                }
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Can not update the records, please try <b>Relogin</b>!";
                    lblMsg.CssClass = "alert alert-danger";
                }
            }
