    ...
    public partial class JobListing : System.Web.UI.Page
    {
        ...
        private void showJobList()
        {
            if (dt == null)
            {
                ...
                string query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,Division,CreateDate from Jobs";
        ...
        protected void lbFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(isCondition)
                {
                    ...
                    query = @"Select JobId,Title,Salary,JobType,CompanyName,CompanyImage,Country,Division,CreateDate from Jobs 
                        where " + subquery + " ";
                }
                else
                {
