<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="Kormo.User.JobListing" %>
                                            ...
                                            <div class="job-items">
                                                ...
                                                <div class="job-tittle job-tittle2">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><i class="fas fa-map-marker-alt"></i><%# Eval("Division") %>, <%# Eval("Country") %></li>
                                                        <li><%# Eval("Salary") %></li>
                                                    </ul>
                                                </div>
                                            </div>
