            ...
            if(Request.QueryString["id"] != null)
            {
                ...
                if(sdr.HasRows)
                {
                    while(sdr.Read())
                    {
                        ...
                        txtDivision.Text = sdr["Division"].ToString();
                        btnAdd.Text = "Update";
            ...
            try
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    query = @"Update Jobs set Title=@Title,NoOfPost=@NoOfPost,Description=@Description,Qualification=@Qualification,
                        ...
                        Email=@Email,Address=@Address,Country=@Country,Division=@Division where JobId=@id";
                    type = "updated";
                    cmd = new SqlCommand(query, con);
                ...
                else
                {
                    ...
                    @Salary,@JobType,@CompanyName,@CompanyImage,@Website,@Email,@Address,@Country,@Division,@CreateDate)";
                    type = "saved";
